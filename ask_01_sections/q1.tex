	...
	\begin{minipage}{0.22\textwidth}
		...
		\begin{tikzpicture}[>=latex]
			\begin{axis}[
				...
				xmax=3,
				xtick={-1.5,0,1.5},
				xticklabels={$V_{LTP}$,$V_{ref}$,$V_{UPT}$},
